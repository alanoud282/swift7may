 ...
 */
var variable = 10
variable += 5 // value is now 15
variable *= 2 // value is now 30
print(variable) // prints 30
 ...
 */
var piggyBank = 0
piggyBank += 10 // value is now 10
piggyBank += 20 // value is now 30
piggyBank /= 2 // value is now 15
piggyBank *= 3 // value is now 45
piggyBank -= 3 // value is now 42
print(piggyBank) // prints 42
