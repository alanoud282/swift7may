 ...
 */
let friends = 999// value from 50 to 100
print("I have \(friends) friends on social media.") // printi
...
//Because we have defined it as a constant, we cannot change it that way
// we can like this
let friends = 666
print("I have \(friends) friends on social media.")
